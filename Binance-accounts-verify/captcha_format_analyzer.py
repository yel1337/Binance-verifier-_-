...
def test_captcha_endpoint_formats():
    ...
    # Test different data formats    formats_to_test = [
    formats_to_test = [{
    ...
    try:
        ...
        if precheck_response.status_code == 200 and precheck_response.text.strip():
            try:
                ...
                if 'data' in precheck_json and 'sessionId' in precheck_json['data']:
                    ...
                    validate_url = f'{BASE_URL}/bapi/accounts/v1/public/account/captcha/validateCaptcha'
...
def analyze_headers_and_timing():
    ...
    url = f'{BASE_URL}/bapi/accounts/v1/public/account/captcha/validateCaptcha'
...
if __name__ == "__main__":
    print("🚀 Starting Captcha Format Analysis...")
